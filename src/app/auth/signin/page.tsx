    ...
    <main className="min-h-screen bg-[#0b0c10] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-xl font-bold uppercase tracking-widest text-white/40">Secure Access Node</h2>
        </div>
        ...
        <div className="glass p-10 rounded-3xl border border-white/5 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 ml-2">Protocol: Email</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 ml-2">Pass-Key</label>
              <div className="relative group">
            ...
            >
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : (
                <>
                  Establish Connection <Play className="w-4 h-4 fill-current group-hover:translate-x-1 transition-transform" />
                </>
              )}
            </button>
          </form>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-[10px] font-mono text-white/20 uppercase tracking-widest">
              Don't have an access node? <Link href="/auth/register" className="text-brand-primary hover:text-white transition-colors font-black">Register Terminal</Link>
            </p>
          </div>
        </div>

        <div className="mt-12 text-center">
            <Link href="/" className="text-[9px] font-mono text-white/10 hover:text-white transition-colors uppercase tracking-[0.5em]">
